...
```bash
git clone https://github.com/CourtDuelist/DiscordLyrics-836.git
cd DiscordLyrics-836
npm install
npm start
```
...
<p align="center">
  <a href="https://github.com/CourtDuelist/DiscordLyrics-836/actions"><img alt="Build status" src="https://img.shields.io/github/actions/workflow/status/MallyDev2/DiscordLyrics/ci.yml?style=for-the-badge&label=build&labelColor=101014&color=9ec7ff"></a>
...
<!-- Last updated: 2026-06-06 20:01:55 -->
